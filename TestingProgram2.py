...
if __name__ == '__main__':
    ...
    canvas.tag_bind('one', '<Button-1>',  lambda event: fun(1))
    ...
    canvas.tag_bind('two', '<Button-1>', lambda event: fun(2))
    ...
    canvas.tag_bind('three', '<Button-1>', lambda event: fun(3))
    ...
    canvas.tag_bind('four', '<Button-1>', lambda event: fun(4))
    ...
    canvas.tag_bind('five', '<Button-1>', lambda event: fun(5))
    ...
    canvas.tag_bind('six', '<Button-1>', lambda event: fun(6))
    ...
    canvas.tag_bind('seven', '<Button-1>', lambda event: fun(7))
    ...
    canvas.tag_bind('eghit', '<Button-1>', lambda event: fun(8))
    ...
    canvas.tag_bind('nine', '<Button-1>', lambda event: fun(9))
    ...
    canvas.tag_bind('ten', '<Button-1>', lambda event: fun(10))
    ...
    canvas.tag_bind('eleven', '<Button-1>', lambda event: fun(11))
    ...
    canvas.tag_bind('12', '<Button-1>', lambda event: fun(12))
    ...
    canvas.tag_bind('13', '<Button-1>', lambda event: fun(13))
    ...
    canvas.tag_bind('14', '<Button-1>', lambda event: fun(14))
    ...
    canvas.tag_bind('15', '<Button-1>', lambda event: fun(15))
    ...
    canvas.tag_bind('16', '<Button-1>', lambda event: fun(16))
    ...
    canvas.tag_bind('17', '<Button-1>', lambda event: fun(17))
    ...
    canvas.tag_bind('18', '<Button-1>', lambda event: fun(18))
    ...
    canvas.tag_bind('19', '<Button-1>', lambda event: fun(19))
    ...
    canvas.tag_bind('20', '<Button-1>', lambda event: fun(20))
    ...
    canvas.tag_bind('21', '<Button-1>', lambda event: fun(21))
    ...
    canvas.tag_bind('22', '<Button-1>', lambda event: fun(22))
    ...
    canvas.tag_bind('23', '<Button-1>', lambda event: fun(23))
    ...
    canvas.tag_bind('24', '<Button-1>', lambda event: fun(24))
    ...
    canvas.tag_bind('25', '<Button-1>', lambda event: fun(25))
    ...
    canvas.tag_bind('26', '<Button-1>', lambda event: fun(26))
    ...
    canvas.tag_bind('27', '<Button-1>', lambda event: fun(27))
    ...
    canvas.tag_bind('28', '<Button-1>', lambda event: fun(28))
    ...
    canvas.tag_bind('29', '<Button-1>', lambda event: fun(29))
    ...
    canvas.tag_bind('30', '<Button-1>', lambda event: fun(30))
    ...
    canvas.tag_bind('31', '<Button-1>', lambda event: fun(31))
    ...
    canvas.tag_bind('32', '<Button-1>', lambda event: fun(32))
    ...
    canvas.tag_bind('33', '<Button-1>', lambda event: fun(33))
    ...
    canvas.tag_bind('34', '<Button-1>', lambda event: fun(34))
    ...
    canvas.tag_bind('35', '<Button-1>', lambda event: fun(35))
    ...
    canvas.tag_bind('36', '<Button-1>', lambda event: fun(36))
    ...
    canvas.tag_bind('37', '<Button-1>', lambda event: fun(37))
    ...
    canvas.tag_bind('38', '<Button-1>', lambda event: fun(38))
    ...
    canvas.tag_bind('39', '<Button-1>', lambda event: fun(39))
    ...
    canvas.tag_bind('40', '<Button-1>', lambda event: fun(40))
    ...
    canvas.tag_bind('41', '<Button-1>', lambda event: fun(41))
    ...
    canvas.tag_bind('42', '<Button-1>', lambda event: fun(42))
    ...
    canvas.tag_bind('43', '<Button-1>', lambda event: fun(43))
    ...
    canvas.tag_bind('44', '<Button-1>', lambda event: fun(44))
    ...
    canvas.tag_bind('45', '<Button-1>', lambda event: fun(45))
    ...
    canvas.tag_bind('46', '<Button-1>', lambda event: fun(46))
    ...
    canvas.tag_bind('47', '<Button-1>', lambda event: fun(47))
    ...
    canvas.tag_bind('48', '<Button-1>', lambda event: fun(48))
    ...
    canvas.tag_bind('49', '<Button-1>', lambda event: fun(49))
    ...
    canvas.tag_bind('50', '<Button-1>', lambda event: fun(50))
    ...
    canvas.tag_bind('51', '<Button-1>', lambda event: fun(51))
